...
CYBERJACK_SCRIPT = REPO_ROOT / "plugins" / "nac-cyberjack-rfid" / "scripts" / "check_readiness.py"
...
def load_cyberjack_module() -> ModuleType:
    spec = importlib.util.spec_from_file_location("nac_cyberjack_readiness", CYBERJACK_SCRIPT)
