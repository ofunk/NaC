...
| [ausweisapp-eid-plugin-integration.md](ausweisapp-eid-plugin-integration.md) | Local AusweisApp eID session preflight | AusweisApp, reader path, purpose, claim set, backend route | metadata-only eID preflight and approved session boundary | AusweisApp version, certificate, claim set and retention |
...
| [ben-portal-plugin-integration.md](ben-portal-plugin-integration.md) | beN portal, XNP and card-reader companion | XNP first setup, BNotK card/token and beN availability | Activation, receive, send, beN-to-beA and evidence | XNP/beN versions, card-reader drift, export evidence |
| [bea-portal-plugin-integration.md](bea-portal-plugin-integration.md) | beA portal, card-reader and client-security companion | Local beA, card-reader and token prerequisites | Send/receive/eEB workflow | Incidents, versions, evidence |
