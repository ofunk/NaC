...
| [ausweisapp-eid-plugin-integration.md](ausweisapp-eid-plugin-integration.md) | Lokale AusweisApp-eID-Sessionvorbereitung | AusweisApp, Reader-Pfad, Zweck, Claim-Set, Backend-Route | metadata-only eID-Preflight und genehmigte Session-Grenze | AusweisApp-Version, Zertifikat, Claim-Set und Retention |
...
| [ben-portal-plugin-integration.md](ben-portal-plugin-integration.md) | beN-Portal, XNP- und Kartenleser-Companion | XNP-Ersteinrichtung, BNotK-Karte/Token und beN-Verfuegbarkeit | Aktivierung, Empfang, Versand, beN-zu-beA und Evidence | XNP-/beN-Versionen, Kartenleser-Drift, Exportnachweise |
| [bea-portal-plugin-integration.md](bea-portal-plugin-integration.md) | beA-Portal, Kartenleser- und Client-Security Companion | lokale beA-, Kartenleser- und Token-Voraussetzungen | Versand-/Empfangs-/eEB-Workflow | Stoerungen, Versionen, Evidence |
